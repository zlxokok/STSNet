...
from ..base.context_module import CFPModule
from ..base.attention import SE_Block, CBAMLayer, CoordAtt
import torch.nn as nn
from ..base.modules import *
...
class ResNetEncoder(ResNet, EncoderMixin):
    def __init__(self, out_channels, depth=5, **kwargs):
        ...
        self._in_channels = 3
        self.iaff1 = eca_layer(64)
        self.iaff2 = eca_layer(256)
        self.iaff3 = eca_layer(512)
        self.iaff4 = eca_layer(1024)
        self.iaff5 = eca_layer(2048)


        #
        # self.spa1 = spatial_attention()
        # self.spa2 = spatial_attention()
        # self.spa3 = spatial_attention()
        # self.spa4 = spatial_attention()
        # self.spa5 = spatial_attention()
        #
        ...
        #
        # self.CFP1 = CFPModule(64, d = 8)
        # self.CFP2 = CFPModule(256, d = 8)
        # self.CFP3 = CFPModule(512, d = 8)
        # self.CFP4 = CFPModule(1024, d = 8)
        # self.CFP5 = CFPModule(2048, d = 8)



        # self.se = SE_Block(2048)
        # self.cbam = CBAMLayer(2048)

        # self.Coordinate = CoordAtt(2048,2048)
        del self.fc
        del self.avgpool
